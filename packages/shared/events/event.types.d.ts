export type EventType = 'USER_REGISTERED' | 'LOGIN_SUCCESSFUL' | 'MEMBERSHIP_ACTIVATED' | 'PAYMENT_COMPLETED' | 'JOB_PUBLISHED' | 'JOB_VIEWED' | 'JOB_APPLIED' | 'CANDIDATE_SHORTLISTED';
